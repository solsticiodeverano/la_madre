...
function setup(){
  ...
  dust=new CosmicDust(900,760); sun=new NetworkSun(420); system=new SpiralSystem(); earth=new EarthCultures();
}
function draw(){
  ...
  let a3=softStep(.62,.78,travel)*(1-softStep(.86,.94,travel)); if(a3>0){push(); system.draw(t); sun.draw(t); pop();}
